...
from model.VRDM.base.modules.diffusionmodules.util import (
    checkpoint,
    conv_nd,
    linear,
    avg_pool_nd,
...
from model.VRDM.base.modules.attention import SpatialTransformer
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None,**kwargs):
        ...
        # print(self.attention_resolutions)
        # print(self.dropout)
        # print(self.channel_mult)
        # print(self.conv_resample)
        # print(self.num_classes)
        # print(self.use_checkpoint)
        
        # print(self.num_heads )
        # print(self.num_head_channels) 
        # print(self.num_heads_upsample)
